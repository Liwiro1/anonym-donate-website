        ...
        <table class="table table-hover table-bordered table-striped">
            ...
            <form action="" method="post">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <select class="form-select mb-2 text-center" aria-label="Default select example"
                                ...
                                <option value="4">Sipariş İptal Edildi</option>
                            </select>
                        </td>
                ...
                if(isset($_POST['update_button'])){
                    ...
                    $forth_option = "Sipariş İptal Edildi";
                    ...
                    if($new_order_status == "2"){
                        ...
                        header("refresh:0");
                    }else if($new_order_status == "4"){
                        mysqli_query($conn, "UPDATE `orders` SET `order_status` = '$forth_option' WHERE `orders`.`id` = '$gelen_id'") or die('query failed');
                        header("refresh:0");
                    }else{
                        header("refresh:0");
                    }
